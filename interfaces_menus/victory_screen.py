...
# creating the victory screen for after completing a level
def victory_screen(screen, resolution, coins_earned, minutes, seconds, enemies_defeated, level, player,
    ...
    """
    Displays the victory screen after completing a level.

    This function sets up a Pygame window with the victory message, statistics, and buttons for proceeding to the next level or returning to the map.
    ...
    level : int
        The level the player completed.
    player : object
        The player object.
